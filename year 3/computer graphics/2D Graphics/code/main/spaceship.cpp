...
#	elif SPACESHIP == SPACESHIP_CUSTOM
	//static constexpr float xs[] = { 5.f, 15.f, 25.f, 35.f };
	//static constexpr float ys[] = { -35.f, -25.f, -5.f, 5.f, 15.f, 45.f };

	float scale = 13.f;

	LineStrip spaceship{ {
		{ scale * 4.5f, scale * 0.0f },
		{ scale * 3.5f, scale * -0.5f },
		{ scale * 1.5f, scale * -0.5f },
		{ scale * 0.5f, scale * -1.5f },
		{ scale * -0.5f, scale * -1.5f },
		{ scale * -1.5f, scale * -2.5f },
		{ scale * 1.5f, scale * -2.5f },
		{ scale * 1.5f, scale * -3.5f },
		{ scale * -3.5f, scale * -3.5f },
		{ scale * -3.5f, scale * -2.5f },
		{ scale * -2.5f, scale * -2.5f },
		{ scale * -3.5f, scale * -1.5f },
		{ scale * -2.5f, scale * -0.5f },
		{ scale * -2.5f, scale * 0.0f },
