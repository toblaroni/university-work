...
#				endif
		...
		switch( testId )
		{
			...
			case 7: {
				...
				draw_line_solid(
					surface,
					{ fbwidth/4.f, fbheight/2.f - 1 },
					{ (fbwidth/4.f)*3, fbheight/2.f - 1 },
					{ 255, 255, 255 }
				);
			...
			case 8: {
				draw_line_solid(
					surface,
					{ fbwidth/2.f - 2, fbheight / 4.f },
					{ fbwidth/2.f - 2, (fbheight*3.f) / 4.f },
					{ 255, 255, 255 }
				);
